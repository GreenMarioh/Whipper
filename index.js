...
client.on("ready", async () => {
  ...
  command(client, "ping", (message) => {
    let thumbnails = [
      "https://cdn.discordapp.com/emojis/666720748391497758.png?v=1",
      "https://cdn.discordapp.com/emojis/730555338973249596.gif?v=1",
      "https://cdn.discordapp.com/emojis/741561706022567956.gif?v=1",
      "https://cdn.discordapp.com/emojis/715578711801462865.gif?v=1",
      "https://cdn.discordapp.com/emojis/585838219166351389.gif?v=1",
      "https://cdn.discordapp.com/emojis/779276228724654100.png?v=1",
      "https://cdn.discordapp.com/emojis/387639044961730563.png?v=1",
      "https://cdn.discordapp.com/emojis/408369856220495873.png?v=1",
      "https://cdn.discordapp.com/emojis/726382468994695201.png?v=1",
    ];
  ...
  command(client, "legend", (message) => {
    ...
    let legendThumbnails = [
      "https://cdn.discordapp.com/emojis/543148999700512768.png?v=1",
      "https://cdn.discordapp.com/emojis/544634720965623811.png?v=1",
      "https://cdn.discordapp.com/emojis/645173676203048963.png?v=1",
      "https://cdn.discordapp.com/emojis/543149031812104223.png?v=1",
      "https://cdn.discordapp.com/emojis/543149042427756544.png?v=1",
      "https://cdn.discordapp.com/emojis/801052875434098701.png?v=1",
      "https://cdn.discordapp.com/emojis/543149075248185344.png?v=1",
      "https://cdn.discordapp.com/emojis/773859165587636235.png?v=1",
      "https://cdn.discordapp.com/emojis/736589673622798437.png?v=1",
      "https://cdn.discordapp.com/emojis/543149053853302874.png?v=1",
      "https://cdn.discordapp.com/emojis/744979953136697375.png?v=1",
      "https://cdn.discordapp.com/emojis/743264763026604047.png?v=1",
      "https://cdn.discordapp.com/emojis/543149022035312641.png?v=1",
      "https://cdn.discordapp.com/emojis/587000606657609743.png?v=1",
      "https://cdn.discordapp.com/emojis/543149085847322662.png?v=1",
    ...
    const legendsEmbed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://cdn.discordapp.com/emojis/679605434994393118.png"
      )
  ...
  command(client, "agent", (message) => {
    ...
    let agentThumbnails = [
      "https://cdn.discordapp.com/emojis/798624357261508618.png?v=1",
      "https://cdn.discordapp.com/emojis/709827557654134870.png?v=1",
      "https://cdn.discordapp.com/emojis/709827547302723657.png?v=1",
      "https://cdn.discordapp.com/emojis/771887035774533672.png?v=1",
      "https://cdn.discordapp.com/emojis/709827534052655237.png?v=1",
      "https://cdn.discordapp.com/emojis/717152051767017522.png?v=1",
      "https://cdn.discordapp.com/emojis/709827522338226237.png?v=1",
      "https://cdn.discordapp.com/emojis/709827510552100898.png?v=1",
      "https://cdn.discordapp.com/emojis/709827500120997958.png?v=1",
      "https://cdn.discordapp.com/emojis/803711976307949619.png?v=1",
      "https://cdn.discordapp.com/emojis/709827488141803590.png?v=1",
      "https://cdn.discordapp.com/emojis/709827472816078858.png?v=1",
      "https://cdn.discordapp.com/emojis/709827460916576266.png?v=1",
      "https://cdn.discordapp.com/emojis/709827450107985920.png?v=1",
      "https://cdn.discordapp.com/emojis/818987103022743562.png?v=1",
    ];
    ...
    const agentsEmbed = new Discord.MessageEmbed()
      .setAuthor(
        "VALORANT Randomizer",
        "https://cdn.discordapp.com/emojis/683973971984777299.png"
      )
      .setColor("#FF4655")
...
client.on("message", async (message) => {
  ...
  if (message.channel.id == `832901660455206942`) {
    if (message.author.bot && message.content.includes("Only Vibes")) {
      return;
    } else if (
      message.content !=
      "https://media.discordapp.net/attachments/238446384808722433/819929391748481034/catvibe.gif"
    ) {
      message.delete();
  ...
  if (foundInTextSlur) {
    if (message.guild.id == 826338678401925120) {
      ...
      sendMessage(
        message.channel,
        `<@${message.author.id}> Watch your language`,
        5
      );
    }
